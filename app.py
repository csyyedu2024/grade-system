...
with st.form("grade_registration_form", clear_on_submit=True):
    ...
    with col1:
        ...
        school = st.selectbox(
            "🏫 學校", 
            options=["土城國中", "海山國中", "江翠國中", "重慶國中", "新莊國中", "長安國中", "豐原國中（台中）", "板橋國小", "廣福國小", "土城國小", "新埔國小", "後埔國小", "海山國小", "思賢國小", "昌平國小",  "沙崙國小", "沙崙國小", "厚德國小", "長安國小", "國語實小", "博嘉實小", "私立育才國小", "私立康橋國小", "私立裕德國小", "私立福瑞斯特中小學", "台北歐洲學校"], 
            index=None, 
            placeholder="請選擇學校"
        )
    with col2:
